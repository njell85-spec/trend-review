...
5. 마스터플랜 Artifact(대화형 계획서, HTML): **v10** = https://claude.ai/code/artifact/757a28f8-bef7-4d5d-bc38-0dbccf747a5f
   (Phase 트래커·P1 개정 절차·P2 큐레이션 버튼 확정·남은 일·확정 결정·§11 요지). v9 이하는 구버전, 링크는 v9와 동일.
...
### ★ P1 · 다음 세션 최우선 = 영상·카드 품질 개선 (승인 게이트 재도전)
...
### P2 · 대시보드 큐레이션 버튼 2종 (PeterJ 확정 2026-07-06 — P1 다음 착수)
...
- **선행 조건**: P1(시각 품질) 승인 후 착수. REPORT_SPEC §4-F 운영 모드 문구 갱신 동반
  (spec-lint 고정 문구 2종은 불변).
