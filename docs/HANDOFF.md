...
5. 마스터플랜 Artifact(대화형 계획서, HTML): **v11** = https://claude.ai/code/artifact/757a28f8-bef7-4d5d-bc38-0dbccf747a5f
   (로드맵 R1~R5·NotebookLM 데이터 설계 확정·큐레이션 버튼·품질 개선·§11 요지). v10 이하는 구버전, 링크 동일.
...
→ R3 **아카이브 자동화 구현**(§3 개정안: b′ 전문 Doc + c 웹 레퍼런스 수집 + notebooklm-py
등록 자동화 + 월 1일 카톡 리마인더 폴백. REPORT_SPEC §4-E 갱신 동반) → R4 **큐레이션 버튼 2종**(P2)
