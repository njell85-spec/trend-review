...
5. **TR master plan** (통합 계획서 Artifact, HTML): **v14** = https://claude.ai/code/artifact/757a28f8-bef7-4d5d-bc38-0dbccf747a5f
   ...
   **★ 이름·운영 규칙(PeterJ 확정 2026-07-07 — 반드시 준수)**:
   ...
   - **버전 누적**: 갱신 때마다 문서 안 "버전 기록" 맨 위에 새 줄 추가(옛 줄 삭제 금지), 라벨도 올림
     (현재 v14-TR-master-plan-merged). 같은 URL 유지(구버전은 버전 선택기 + 문서 내 기록에 보존).
